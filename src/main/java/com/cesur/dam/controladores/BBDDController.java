...
public class BBDDController {
	...
	// Mediante un POST, podemos subir un archivo al proyecto y guardarlo en el
	// directorio estipulado en el método guardarArchivo() de FileService
	@ResponseBody
	...
	// Al igual que el método anterior, nos permite borrar un archivo del directorio
	// en el que se encuentran dentro del proyecto
	@ResponseBody
	...
	// Controlador para trabajar con la tabla clientes de la base de datos, permite
	...
	// Permite generar un xml de la tabla Clientes de la base de datos y mostrarlo
	// en postman
	@RestController
	@RequestMapping("/xml")
	...
	// Controllador para obtener un listado de todas las aseguradoras almacenadas en
	// la BBDD
	@RestController
